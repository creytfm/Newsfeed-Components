...
function createArticle(title, date, firstParagraph, secondParagraph, thirdParagraph) {
  ...
  const frstParagraph = document.createElement("p");
  const scndParagraph = document.createElement("p");
  const thrdParagraph = document.createElement("p");

  article.appendChild(artTitle);
  article.appendChild(artDate);
  article.appendChild(frstParagraph);
  article.appendChild(scndParagraph);
  article.appendChild(thrdParagraph);
  ...
  frstParagraph.textContent = firstParagraph;
  scndParagraph.textContent = secondParagraph;
  thrdParagraph.textContent = thirdParagraph;
